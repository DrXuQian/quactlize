...
|---|---|
| Real optimized-reader entry and recipe identity | V1 BOX RED, V2 COMPILED; RTX5070 numerical A/B PASS (3,072 fixed GREEN,2,496 expected legacy affine RED,576 legacy META GREEN); PPU re-admission pending. The port shared signed `q-8` with unsigned affine readers: independent missing-term error0.6095335058 matches box0.609534. Explicit compile-time code bias and fully generated fast helper restored; no layout/routing change. [Root cause](../../Q4_MOE_S1_NUMERIC_FIX.md). Additive `q4_s1_api.h`, old selector unchanged; [gate](../../docs/Q4_MOE_S1_GATE.md) six shapes/16 recipes/F16+F32/192 specializations. |
