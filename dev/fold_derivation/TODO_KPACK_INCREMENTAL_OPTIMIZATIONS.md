...
| Unified sweep and heuristic | NEXT; MoE S1 numeric entry gate closed. Retain previous TC best configs and actual Split-K cost. Add the measured GEMV recipes to the same selection, reconfirm18 noisy MoE cases and preserve near ties (75/108 finalist pairs within5%). Publish exact coverage and unsupported fallback. Dense boundaries above are not MoE policy. |
